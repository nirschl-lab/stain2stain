...
ckpt_path = "logs/train/runs/2026-01-27_15-48-34/checkpoints/best-099-0.1498.ckpt"
...
save_folder = "multitask_multiclass_50steps"
image_size = 256
...
def main():
    ...
    model_config = OmegaConf.load("configs/model/conditional_flow_matching_multitask_multiclass.yaml")
    ...
    with torch.no_grad():
        for idx in tqdm(range(num_to_process), desc="Processing images"):
            try:
                ...
                # Generate prediction
                generated_img, pred_mask = model.generate(source_img, num_steps=num_steps)
